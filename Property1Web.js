...
export default function Property1Web (props) {
	return (
		<div className={`Property1Web_Property1Web ${props.className}`}>
			<div className='HeroNavBar'>
				<div className='KickoffLogo'>
					<img className='KickoffKits' src = {ImgAsset.Property1Web_KickoffKits} />
				</div>
