...
import './Property1MobileHover.css'
import ImgAsset from '../public'
import Star from "./Star"
export default function Property1MobileHover (props) {
	return (
		<div className={`Property1MobileHover_Property1MobileHover ${props.className}`}>
