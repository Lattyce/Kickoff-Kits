...
import './Property1MobileDefault_1.css'
import ImgAsset from '../public'
import Star from "./Star"
export default function Property1MobileDefault_1 (props) {
	return (
		<div className={`Property1MobileDefault_1_Property1MobileDefault ${props.className}`}>
